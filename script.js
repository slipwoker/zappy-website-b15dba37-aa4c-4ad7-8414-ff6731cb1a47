document.addEventListener('DOMContentLoaded', function () {
  ...
  function clearFieldError(field) {
    ...
    const errorEl = field.parentElement && field.parentElement.querySelector('.field-error');
  ...
  function applyStaggerDelay(elements) {
    ...
    elements.forEach(function (el) {
      ...
      const key = parent ? parent : '__root__';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'b15dba37-aa4c-4ad7-8414-ff6731cb1a47',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'b15dba37-aa4c-4ad7-8414-ff6731cb1a47';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b15dba37-aa4c-4ad7-8414-ff6731cb1a47';
